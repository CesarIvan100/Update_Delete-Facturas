...
switch ($_GET["op"]) {
    ...
    default:
        ...
        // Manejo de solicitudes para actualizar
        public function update() {
            ...
            $result = $this->model->updateFactura($id, $datos);
            echo $result ? "Actualización exitosa" : "Error en la actualización";
        }
    
        // Manejo de solicitudes para eliminar
        public function delete() {
            $id = $_POST['id'];
            $result = $this->model->deleteFactura($id);
            echo $result ? "Eliminación exitosa" : "Error en la eliminación";
        }
